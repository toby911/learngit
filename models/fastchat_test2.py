...
# openai.api_base = 'https://u152649-b607-e934aa4f.westa.seetacloud.com:8443/v1/'
...
AGENT_TMPL = """尽可能回答下面的问题。你可以使用下面这些工具来帮你回答问题，工具名称和功能描述如下：
...
Action:  {tool_names} 中的其中一个工具名，注意只能是{tool_names}的其中的一个
Action Input: 工具所需要的输入
Observation: 工具返回的结果
...
if __name__ == "__main__":
    ...
    tools = [
        Tool(
            ...
            description="使用这个工具来查询产品描述，输入应该是产品名称",
        ),
        Tool(
            name="company_query",
